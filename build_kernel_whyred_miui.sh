...
echo ""
echo " Cross-compiling AGNi MIUI kernel whyred..."
echo ""
...
then
    make defconfig O=/mnt/ANDROID/COMPILED_OUT ARCH=arm64 agni_whyred_miui_defconfig
fi
...
echo ""
echo "AGNi miui has been built for whyred !!!"
